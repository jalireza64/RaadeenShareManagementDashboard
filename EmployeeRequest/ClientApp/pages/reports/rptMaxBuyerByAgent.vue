<template>
    <div class="rtl page">
        <kendo-window ref="buyDetailWindow" :title="$CaptionsLibrary.get('BuyingMostShare')" :visible="model.isShowBuyDetailWindow" :modal="true">
            <div class="bs-docs-example k-content flex" v-if="kendoMessages">
                ...
                <div class="container">
                    <kendo-grid :data-source="buyDetailDatasource"
                                ref="buyDetailGrid"
                                @databinding="buyDetailGridDataBinding"
                                class="detail-grid"
                                :resizable="true"
                                ...
                                style="height:300px"
                                :pageable="false">
                        <kendo-grid-column :template="`#: ++recordBuyDetailGrid #`"
        ...
        <div class="bs-docs-example k-content flex" v-if="kendoMessages">
            <div class="title k-alt" style="display: grid;grid-template-columns: repeat(1, 1fr)">
                <div style="position:relative">
                    ...
                    <kendo-button id="target" v-show="manuModel.ShowMenu == true" :disabled="this.selectedAgent == null" style="float:left;margin:2px" class="k-button k-primary">
                        <div>
                    ...
                    <div>
                        <kendo-contextmenu :target="'#target'" :show-on="'click'" :align-to-anchor="true">
                            <li @click.prevent="showBuyDetailWindow">
                                <i class="fas fa-file-import"></i>&nbsp;
                                {{$CaptionsLibrary.get('Detail')+' '+$CaptionsLibrary.get('BuyingMostShare')}}
                            </li>
                        </kendo-contextmenu>
                    </div>
                </div>
...
<script lang="ts" src="./rptMaxBuyerByAgent.ts">
</script>
