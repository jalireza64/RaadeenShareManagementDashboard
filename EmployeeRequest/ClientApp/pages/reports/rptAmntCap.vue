        ...
        <kendo-window ref="chartWindow" :title="$CaptionsLibrary.get('Chart')" :visible="chartModel.isShowChart" :modal="true">
            <div class="chart-container">
                <div class="form-group">
                    <kendo-chart :title-text="$CaptionsLibrary.get('PayFromShareholderInCap')"
                                 ref="Chart"
                                 :height="'100px'"
                                 ...
                                 :pannable-lock="'y'"
                                 :theme="'sass'">
                        <kendo-chart-series-item :name="$CaptionsLibrary.get('Amount')" :data="chartModel.amnt" :type="'column'" :markers-visible="false" :k-style="'smooth'" :axis="'amnt'"></kendo-chart-series-item>
                    </kendo-chart>
                </div>
            </div>
        </kendo-window>
                ...
                <div style="position:relative">
                    <div v-show="manuModel.ShowMenu == false" style="float:right;margin:5px;position:absolute">
                        <div style="float:right;margin:5px">
                            ...
                            {{$CaptionsLibrary.get('PayFromShareholderInCap')}}
                        </div>
                    </div>
...
<script lang="ts" src="./rptAmntCap.ts">
</script>
