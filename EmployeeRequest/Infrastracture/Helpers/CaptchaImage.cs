...
namespace EmployeeRequest.Infrastracture.Helpers
{
    ...
    public class CaptchaImage
    {
        ...
        /// </summary>
        public CaptchaImage(string randomText)
        {
            this.random = new Random();

            this.FontWarp = FontWarpFactor.High;
            this.BackgroundNoise = BackgroundNoiseLevel.High;
            this.LineNoise = LineNoiseLevel.Medium;
            this.Width = 150;
            this.Height = 31;
            ...
            this.randomTextLength = randomText.Length; // do not use property - setter generates random text
        ...
        public Bitmap GenerateImage()
        {
            ...
            try
            {
                ...
                int charOffset = 0;
                double charWidth = this.Width / this.randomTextLength;
